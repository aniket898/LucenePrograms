...
public class Indexer{
    ...
    public IndexWriter getIndexWriter(boolean create) throws IOException {
        if (indexWriter == null) {
            Directory indexDir = FSDirectory.open(new File("D:\\ADAPTERANDPLUGINS\\work\\LuceneIndexes"));
    ...
    public void indexHotel(Hotel hotel) throws IOException {
        ...
        System.out.println("iiiii -" +hotel.getCity() );
	...
	private void addHotels() {
		...
		for(int i =0;i<200;i++){
			...
			Hotel hotel = new Hotel(String.valueOf(i), "hotel"+i, "CityHouse", description);
